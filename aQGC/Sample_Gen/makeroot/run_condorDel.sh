...
universe = vanilla
output   = rootLog/rootLog.log
error    = rootLog/rootLog.err
log      = /dev/null
...
transfer_output_files = rootOut
arguments = \$(DATAFile) 
queue DATAFile from ${1}
EOF
if [ ! -d rootLog ]; then mkdir rootLog; fi
