...
stak_lep2_pt = [np.clip(ZZZ_lep2_pt,0,400,ZZZ_lep2_pt), np.clip(WZZ_lep2_pt,0,400,WZZ_lep2_pt), np.clip(WWZ_lep2_pt,0,400,WWZ_lep2_pt) , np.clip(WWW_lep2_pt,0,400,WWW_lep2_pt), np.clip(WG_lep2_pt,0,400,WG_lep2_pt), np.clip(ZG_lep2_pt,0,400,ZG_lep2_pt), np.clip(ZZ_lep2_pt,0,400,ZZ_lep2_pt), np.clip(WZ_lep2_pt,0,400,WZ_lep2_pt), np.clip(WW_lep2_pt,0,400,WW_lep2_pt), np.clip(ttbarG_lep2_pt,0,400,ttbarG_lep2_pt), np.clip(WZG_lep2_pt,0,400,WZG_lep2_pt)]
...
plt.ylim(0, 600)
plt.text(82, 550, '(Combined channel)', fontsize=20)
...
plt.xlim(0, 300)
plt.ylim(0, 500)
plt.text(70, 460, '(Combined channel)', fontsize=20)
...
plt.xlim(0, 700)
plt.ylim(0.1, 10000)
plt.text(130, 2000, '(Combined channel)', fontsize=20)
...
plt.xlim(0, 700)
plt.ylim(0.1, 10000)
plt.text(140, 2000, '(Combined channel)', fontsize=20)
...
plt.xlim(0, 1500)
plt.ylim(0.1, 10000)
plt.text(300, 2000, '(Combined channel)', fontsize=20)
...
plt.xlim(0, 600)
plt.ylim(0.1, 10000)
plt.text(150, 2000, '(Combined channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.concatenate((stak_lep2_pt[:-1])), range=(0, 400), alpha=1,linewidth=2.5, weights=np.concatenate((we[:-1])), bins=10, color='black', label="Only Background", stacked=True,histtype='step')
plt.hist(np.concatenate((stak_lep2_pt)), range=(0, 400), alpha=1,linewidth=2.5, weights=np.concatenate((we)), bins=10, color='red', label="Include WZ$\gamma$", stacked=True,histtype='step')

plt.hist(stak_lep2_pt, range=(0, 400), alpha=0.7, weights=we, bins=10, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 400)
plt.ylim(0.1, 10000)
plt.text(75, 2000, '(Combined channel)', fontsize=20)
...
plt.xlim(0, 400)
plt.ylim(0.1, 10000)
plt.text(100, 2000, '(Combined channel)', fontsize=20)
