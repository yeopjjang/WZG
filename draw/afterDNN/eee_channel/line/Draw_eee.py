...
stak_pho = [np.clip(WG_pho,0,440,WG_pho), np.clip(ZZZ_pho,0,440,ZZZ_pho), np.clip(WZZ_pho,0,440,WZZ_pho), np.clip(WWW_pho,0,440,WWW_pho), np.clip(WWZ_pho,0,440,WWZ_pho) , np.clip(WW_pho,0,440,WW_pho), np.clip(ZG_pho,0,440,ZG_pho), np.clip(ZZ_pho,0,440,ZZ_pho), np.clip(ttbarG_pho,0,440,ttbarG_pho), np.clip(WZ_pho,0,440,WZ_pho)]

stak_MET = [np.clip(WG_MET,0,440,WG_MET), np.clip(ZZZ_MET,0,440,ZZZ_MET), np.clip(WZZ_MET,0,440,WZZ_MET), np.clip(WWW_MET,0,440,WWW_MET), np.clip(WWZ_MET,0,440,WWZ_MET) , np.clip(WW_MET,0,440,WW_MET), np.clip(ZG_MET,0,440,ZG_MET), np.clip(ZZ_MET,0,440,ZZ_MET), np.clip(ttbarG_MET,0,440,ttbarG_MET), np.clip(WZ_MET,0,440,WZ_MET)]

stak_triM = [np.clip(WG_Trilep_mass,0,1200,WG_Trilep_mass), np.clip(ZZZ_Trilep_mass,0,1200,ZZZ_Trilep_mass), np.clip(WZZ_Trilep_mass,0,1200,WZZ_Trilep_mass), np.clip(WWW_Trilep_mass,0,1200,WWW_Trilep_mass), np.clip(WWZ_Trilep_mass,0,1200,WWZ_Trilep_mass) , np.clip(WW_Trilep_mass,0,1200,WW_Trilep_mass), np.clip(ZG_Trilep_mass,0,1200,ZG_Trilep_mass), np.clip(ZZ_Trilep_mass,0,1200,ZZ_Trilep_mass), np.clip(ttbarG_Trilep_mass,0,1200,ttbarG_Trilep_mass), np.clip(WZ_Trilep_mass,0,1200,WZ_Trilep_mass)]

stak_lep1_pt = [np.clip(WG_lep1_pt,0,600,WG_lep1_pt), np.clip(ZZZ_lep1_pt,0,600,ZZZ_lep1_pt), np.clip(WZZ_lep1_pt,0,600,WZZ_lep1_pt), np.clip(WWW_lep1_pt,0,600,WWW_lep1_pt), np.clip(WWZ_lep1_pt,0,600,WWZ_lep1_pt) , np.clip(WW_lep1_pt,0,600,WW_lep1_pt), np.clip(ZG_lep1_pt,0,600,ZG_lep1_pt), np.clip(ZZ_lep1_pt,0,600,ZZ_lep1_pt), np.clip(ttbarG_lep1_pt,0,600,ttbarG_lep1_pt), np.clip(WZ_lep1_pt,0,600,WZ_lep1_pt)]

stak_lep2_pt = [np.clip(WG_lep2_pt,0,300,WG_lep2_pt), np.clip(ZZZ_lep2_pt,0,300,ZZZ_lep2_pt), np.clip(WZZ_lep2_pt,0,300,WZZ_lep2_pt), np.clip(WWW_lep2_pt,0,300,WWW_lep2_pt), np.clip(WWZ_lep2_pt,0,300,WWZ_lep2_pt) , np.clip(WW_lep2_pt,0,300,WW_lep2_pt), np.clip(ZG_lep2_pt,0,300,ZG_lep2_pt), np.clip(ZZ_lep2_pt,0,300,ZZ_lep2_pt), np.clip(ttbarG_lep2_pt,0,300,ttbarG_lep2_pt), np.clip(WZ_lep2_pt,0,300,WZ_lep2_pt)]

stak_lep3_pt = [np.clip(WG_lep3_pt,0,500,WG_lep3_pt), np.clip(ZZZ_lep3_pt,0,500,ZZZ_lep3_pt), np.clip(WZZ_lep3_pt,0,500,WZZ_lep3_pt), np.clip(WWW_lep3_pt,0,500,WWW_lep3_pt), np.clip(WWZ_lep3_pt,0,500,WWZ_lep3_pt) , np.clip(WW_lep3_pt,0,500,WW_lep3_pt), np.clip(ZG_lep3_pt,0,500,ZG_lep3_pt), np.clip(ZZ_lep3_pt,0,500,ZZ_lep3_pt), np.clip(ttbarG_lep3_pt,0,500,ttbarG_lep3_pt), np.clip(WZ_lep3_pt,0,500,WZ_lep3_pt)]
...
plt.ylim(0, 25)
plt.text(82, 22, '(eee channel)', fontsize=20)
...
plt.xlim(0, 250)
plt.ylim(0, 20)
plt.text(100, 18, '(eee channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_pho,0,440,WZG_pho), range=(0, 440), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_pho, range=(0, 440), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 440)
plt.ylim(0.01, 1000)
plt.text(180, 200, '(eee channel)', fontsize=20)
plt.xlabel("Photon $p_{T}$ [GeV]",fontsize=20, loc='center')
plt.ylabel("Expected Yield | 22 GeV",fontsize=20, loc='center')
plt.legend(fontsize=12, loc='upper right')
plt.yscale('log')
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_MET,0,440,WZG_MET), range=(0, 440), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_MET, range=(0, 440), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 440)
plt.ylim(0.01, 1000)
plt.text(180, 200, '(eee channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_Trilep_mass,0,1200,WZG_Trilep_mass), range=(0, 1200), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_triM, range=(0, 1200), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 1200)
plt.ylim(0.01, 1000)
plt.text(450, 200, '(eee channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_lep1_pt,0,600,WZG_lep1_pt), range=(0, 600), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_lep1_pt, range=(0, 600), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 600)
plt.ylim(0.01, 1000)
plt.text(200, 200, '(eee channel)', fontsize=20)
...
plt.xlim(0, 300)
plt.ylim(0.01, 1000)
plt.text(120, 200, '(eee channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_lep3_pt,0,500,WZG_lep3_pt), range=(0, 500), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_lep3_pt, range=(0, 500), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 500)
plt.ylim(0.01, 1000)
plt.text(200, 200, '(eee channel)', fontsize=20)
