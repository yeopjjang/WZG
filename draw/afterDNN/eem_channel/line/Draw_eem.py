...
stak_MET = [np.clip(WG_MET,0,600,WG_MET), np.clip(ZZZ_MET,0,600,ZZZ_MET), np.clip(WZZ_MET,0,600,WZZ_MET), np.clip(WWW_MET,0,600,WWW_MET), np.clip(WWZ_MET,0,600,WWZ_MET) , np.clip(WW_MET,0,600,WW_MET), np.clip(ZG_MET,0,600,ZG_MET), np.clip(ZZ_MET,0,600,ZZ_MET), np.clip(ttbarG_MET,0,600,ttbarG_MET), np.clip(WZ_MET,0,600,WZ_MET)]

stak_triM = [np.clip(WG_Trilep_mass,0,1500,WG_Trilep_mass), np.clip(ZZZ_Trilep_mass,0,1500,ZZZ_Trilep_mass), np.clip(WZZ_Trilep_mass,0,1500,WZZ_Trilep_mass), np.clip(WWW_Trilep_mass,0,1500,WWW_Trilep_mass), np.clip(WWZ_Trilep_mass,0,1500,WWZ_Trilep_mass) , np.clip(WW_Trilep_mass,0,1500,WW_Trilep_mass), np.clip(ZG_Trilep_mass,0,1500,ZG_Trilep_mass), np.clip(ZZ_Trilep_mass,0,1500,ZZ_Trilep_mass), np.clip(ttbarG_Trilep_mass,0,1500,ttbarG_Trilep_mass), np.clip(WZ_Trilep_mass,0,1500,WZ_Trilep_mass)]

stak_lep1_pt = [np.clip(WG_lep1_pt,0,540,WG_lep1_pt), np.clip(ZZZ_lep1_pt,0,540,ZZZ_lep1_pt), np.clip(WZZ_lep1_pt,0,540,WZZ_lep1_pt), np.clip(WWW_lep1_pt,0,540,WWW_lep1_pt), np.clip(WWZ_lep1_pt,0,540,WWZ_lep1_pt) , np.clip(WW_lep1_pt,0,540,WW_lep1_pt), np.clip(ZG_lep1_pt,0,540,ZG_lep1_pt), np.clip(ZZ_lep1_pt,0,540,ZZ_lep1_pt), np.clip(ttbarG_lep1_pt,0,540,ttbarG_lep1_pt), np.clip(WZ_lep1_pt,0,540,WZ_lep1_pt)]

stak_lep2_pt = [np.clip(WG_lep2_pt,0,260,WG_lep2_pt), np.clip(ZZZ_lep2_pt,0,260,ZZZ_lep2_pt), np.clip(WZZ_lep2_pt,0,260,WZZ_lep2_pt), np.clip(WWW_lep2_pt,0,260,WWW_lep2_pt), np.clip(WWZ_lep2_pt,0,260,WWZ_lep2_pt) , np.clip(WW_lep2_pt,0,260,WW_lep2_pt), np.clip(ZG_lep2_pt,0,260,ZG_lep2_pt), np.clip(ZZ_lep2_pt,0,260,ZZ_lep2_pt), np.clip(ttbarG_lep2_pt,0,260,ttbarG_lep2_pt), np.clip(WZ_lep2_pt,0,260,WZ_lep2_pt)]

stak_lep3_pt = [np.clip(WG_lep3_pt,0,400,WG_lep3_pt), np.clip(ZZZ_lep3_pt,0,400,ZZZ_lep3_pt), np.clip(WZZ_lep3_pt,0,400,WZZ_lep3_pt), np.clip(WWW_lep3_pt,0,400,WWW_lep3_pt), np.clip(WWZ_lep3_pt,0,400,WWZ_lep3_pt) , np.clip(WW_lep3_pt,0,400,WW_lep3_pt), np.clip(ZG_lep3_pt,0,400,ZG_lep3_pt), np.clip(ZZ_lep3_pt,0,400,ZZ_lep3_pt), np.clip(ttbarG_lep3_pt,0,400,ttbarG_lep3_pt), np.clip(WZ_lep3_pt,0,400,WZ_lep3_pt)]
...
plt.ylim(0, 35)
plt.text(82, 31, '(ee$\mu$ channel)', fontsize=20)
...
plt.xlim(0, 250)
plt.ylim(0, 30)
plt.text(20, 26, '(ee$\mu$ channel)', fontsize=20)
...
plt.xlim(0, 600)
plt.ylim(0.01, 1000)
plt.text(250, 200, '(ee$\mu$ channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_MET,0,600,WZG_MET), range=(0, 600), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_MET, range=(0, 600), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 600)
plt.ylim(0.01, 1000)
plt.text(250, 200, '(ee$\mu$ channel)', fontsize=20)
...
plt.xlim(0, 1500)
plt.ylim(0.01, 1000)
plt.text(500, 200, '(ee$\mu$ channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_lep1_pt,0,540,WZG_lep1_pt), range=(0, 540), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_lep1_pt, range=(0, 540), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 540)
plt.ylim(0.01, 1000)
plt.text(150, 200, '(ee$\mu$ channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_lep2_pt,0,260,WZG_lep2_pt), range=(0, 260), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_lep2_pt, range=(0, 260), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 260)
plt.ylim(0.01, 1000)
plt.text(100, 200, '(ee$\mu$ channel)', fontsize=20)
plt.xlabel("Sub-leading Electron $p_{T}$ [GeV]",fontsize=20, loc='center')
plt.ylabel("Expected Yield | 13 GeV",fontsize=20, loc='center')
plt.legend(fontsize=12, loc='upper right')
plt.yscale('log')
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_lep3_pt,0,400,WZG_lep3_pt), range=(0, 400), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_lep3_pt, range=(0, 400), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 400)
plt.ylim(0.01, 1000)
plt.text(150, 200, '(ee$\mu$ channel)', fontsize=20)
plt.xlabel("Third Muon $p_{T}$ [GeV]",fontsize=20, loc='center')
plt.ylabel("Expected Yield | 20 GeV",fontsize=20, loc='center')
plt.legend(fontsize=12, loc='upper right')
plt.yscale('log')
