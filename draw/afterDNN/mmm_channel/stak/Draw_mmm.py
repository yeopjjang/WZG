...
plt.ylim(0, 190)
plt.text(82, 175, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.xlim(0, 300)
plt.ylim(0, 170)
plt.text(100, 155, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.xlim(0, 700)
plt.ylim(0.1, 1000)
plt.text(130, 500, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.xlim(0, 700)
plt.ylim(0.1, 1000)
plt.text(140, 500, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.xlim(0, 1500)
plt.ylim(0.1, 1000)
plt.text(300, 500, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.xlim(0, 600)
plt.ylim(0.1, 1000)
plt.text(150, 500, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.xlim(0, 300)
plt.ylim(0.1, 1000)
plt.text(75, 500, '($\mu\mu\mu$ channel)', fontsize=20)
