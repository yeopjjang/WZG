...
# Data Load
infile = '/x4/cms/dylee/Delphes/analysis/ntuple/numpy/fixver/eee_channel.npy'
...
stak_MET = [np.clip(WG_MET,0,800,WG_MET), np.clip(ZZZ_MET,0,800,ZZZ_MET), np.clip(WZZ_MET,0,800,WZZ_MET), np.clip(WWW_MET,0,800,WWW_MET), np.clip(WWZ_MET,0,800,WWZ_MET) , np.clip(WW_MET,0,800,WW_MET), np.clip(ZG_MET,0,800,ZG_MET), np.clip(ZZ_MET,0,800,ZZ_MET), np.clip(ttbarG_MET,0,800,ttbarG_MET), np.clip(WZ_MET,0,800,WZ_MET)]
...
stak_lep1_pt = [np.clip(WG_lep1_pt,0,800,WG_lep1_pt), np.clip(ZZZ_lep1_pt,0,800,ZZZ_lep1_pt), np.clip(WZZ_lep1_pt,0,800,WZZ_lep1_pt), np.clip(WWW_lep1_pt,0,800,WWW_lep1_pt), np.clip(WWZ_lep1_pt,0,800,WWZ_lep1_pt) , np.clip(WW_lep1_pt,0,800,WW_lep1_pt), np.clip(ZG_lep1_pt,0,800,ZG_lep1_pt), np.clip(ZZ_lep1_pt,0,800,ZZ_lep1_pt), np.clip(ttbarG_lep1_pt,0,800,ttbarG_lep1_pt), np.clip(WZ_lep1_pt,0,800,WZ_lep1_pt)]
...
plt.xlim(0, 250)
plt.ylim(0, 175)
plt.text(100, 140, '(eee channel)', fontsize=20)
...
plt.xlim(0, 1700)
plt.ylim(0.01, 10000)
plt.text(500, 2000, '(eee channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_lep1_pt,0,800,WZG_lep1_pt), range=(0, 800), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_lep1_pt, range=(0, 800), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 800)
plt.ylim(0.01, 10000)
...
plt.xlim(0, 400)
plt.ylim(0.01, 10000)
plt.text(150, 2000, '(eee channel)', fontsize=20)
