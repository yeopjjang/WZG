...
# Data Load
infile = '/x4/cms/dylee/Delphes/analysis/ntuple/numpy/fixver/eem_channel.npy'

eem_channel = np.load(infile,allow_pickle=True)[()]
...
stak_pho = [np.clip(WG_pho,0,700,WG_pho), np.clip(ZZZ_pho,0,700,ZZZ_pho), np.clip(WZZ_pho,0,700,WZZ_pho), np.clip(WWW_pho,0,700,WWW_pho), np.clip(WWZ_pho,0,700,WWZ_pho) , np.clip(WW_pho,0,700,WW_pho), np.clip(ZG_pho,0,700,ZG_pho), np.clip(ZZ_pho,0,700,ZZ_pho), np.clip(ttbarG_pho,0,700,ttbarG_pho), np.clip(WZ_pho,0,700,WZ_pho)]
...
stak_lep1_pt = [np.clip(WG_lep1_pt,0,900,WG_lep1_pt), np.clip(ZZZ_lep1_pt,0,900,ZZZ_lep1_pt), np.clip(WZZ_lep1_pt,0,900,WZZ_lep1_pt), np.clip(WWW_lep1_pt,0,900,WWW_lep1_pt), np.clip(WWZ_lep1_pt,0,900,WWZ_lep1_pt) , np.clip(WW_lep1_pt,0,900,WW_lep1_pt), np.clip(ZG_lep1_pt,0,900,ZG_lep1_pt), np.clip(ZZ_lep1_pt,0,900,ZZ_lep1_pt), np.clip(ttbarG_lep1_pt,0,900,ttbarG_lep1_pt), np.clip(WZ_lep1_pt,0,900,WZ_lep1_pt)]

stak_lep2_pt = [np.clip(WG_lep2_pt,0,400,WG_lep2_pt), np.clip(ZZZ_lep2_pt,0,400,ZZZ_lep2_pt), np.clip(WZZ_lep2_pt,0,400,WZZ_lep2_pt), np.clip(WWW_lep2_pt,0,400,WWW_lep2_pt), np.clip(WWZ_lep2_pt,0,400,WWZ_lep2_pt) , np.clip(WW_lep2_pt,0,400,WW_lep2_pt), np.clip(ZG_lep2_pt,0,400,ZG_lep2_pt), np.clip(ZZ_lep2_pt,0,400,ZZ_lep2_pt), np.clip(ttbarG_lep2_pt,0,400,ttbarG_lep2_pt), np.clip(WZ_lep2_pt,0,400,WZ_lep2_pt)]

stak_lep3_pt = [np.clip(WG_lep3_pt,0,700,WG_lep3_pt), np.clip(ZZZ_lep3_pt,0,700,ZZZ_lep3_pt), np.clip(WZZ_lep3_pt,0,700,WZZ_lep3_pt), np.clip(WWW_lep3_pt,0,700,WWW_lep3_pt), np.clip(WWZ_lep3_pt,0,700,WWZ_lep3_pt) , np.clip(WW_lep3_pt,0,700,WW_lep3_pt), np.clip(ZG_lep3_pt,0,700,ZG_lep3_pt), np.clip(ZZ_lep3_pt,0,700,ZZ_lep3_pt), np.clip(ttbarG_lep3_pt,0,700,ttbarG_lep3_pt), np.clip(WZ_lep3_pt,0,700,WZ_lep3_pt)]
...
plt.ylim(0, 150)
plt.text(82, 135, '(ee$\mu$ channel)', fontsize=20)
...
plt.xlim(0, 250)
plt.ylim(0, 180)
plt.text(20, 160, '(ee$\mu$ channel)', fontsize=20)
...
plt.xlim(0, 700)
plt.ylim(0.01, 10000)
plt.text(250, 2000, '(ee$\mu$ channel)', fontsize=20)
...
plt.xlim(0, 1700)
plt.ylim(0.01, 10000)
plt.text(500, 2000, '(ee$\mu$ channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_lep1_pt,0,900,WZG_lep1_pt), range=(0, 900), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_lep1_pt, range=(0, 900), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 900)
plt.ylim(0.01, 10000)
plt.text(200, 2000, '(ee$\mu$ channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_lep2_pt,0,400,WZG_lep2_pt), range=(0, 400), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_lep2_pt, range=(0, 400), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 400)
plt.ylim(0.01, 10000)
plt.text(150, 2000, '(ee$\mu$ channel)', fontsize=20)
