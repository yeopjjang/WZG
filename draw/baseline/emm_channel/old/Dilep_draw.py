...
# Data load
Data = '/x4/cms/dylee/Delphes/analysis/ntuple/ntuple/emm_channel.npy'
#Data = '/x4/cms/dylee/Delphes/analysis/ntuple/oldnpy/emm_channel.npy'
...
plt.ylim(0, 280)
plt.text(82, 250, '(emm channel)', fontsize=20)
