...
# Data Load
infile = '/x4/cms/dylee/Delphes/analysis/ntuple/numpy/fixver/mmm_channel.npy'

mmm_channel = np.load(infile,allow_pickle=True)[()]
...
stak_pho = [np.clip(ZZZ_pho,0,700,ZZZ_pho), np.clip(WZZ_pho,0,700,WZZ_pho), np.clip(WWW_pho,0,700,WWW_pho), np.clip(WWZ_pho,0,700,WWZ_pho) , np.clip(WG_pho,0,700,WG_pho), np.clip(WW_pho,0,700,WW_pho), np.clip(ZG_pho,0,700,ZG_pho), np.clip(ZZ_pho,0,700,ZZ_pho), np.clip(ttbarG_pho,0,700,ttbarG_pho), np.clip(WZ_pho,0,700,WZ_pho)]

stak_MET = [np.clip(ZZZ_MET,0,800,ZZZ_MET), np.clip(WZZ_MET,0,800,WZZ_MET), np.clip(WWW_MET,0,800,WWW_MET), np.clip(WWZ_MET,0,800,WWZ_MET) , np.clip(WG_MET,0,800,WG_MET), np.clip(WW_MET,0,800,WW_MET), np.clip(ZG_MET,0,800,ZG_MET), np.clip(ZZ_MET,0,800,ZZ_MET), np.clip(ttbarG_MET,0,800,ttbarG_MET), np.clip(WZ_MET,0,800,WZ_MET)]
...
stak_lep1_pt = [np.clip(ZZZ_lep1_pt,0,1000,ZZZ_lep1_pt), np.clip(WZZ_lep1_pt,0,1000,WZZ_lep1_pt), np.clip(WWW_lep1_pt,0,1000,WWW_lep1_pt), np.clip(WWZ_lep1_pt,0,1000,WWZ_lep1_pt) , np.clip(WG_lep1_pt,0,1000,WG_lep1_pt), np.clip(WW_lep1_pt,0,1000,WW_lep1_pt), np.clip(ZG_lep1_pt,0,1000,ZG_lep1_pt), np.clip(ZZ_lep1_pt,0,1000,ZZ_lep1_pt), np.clip(ttbarG_lep1_pt,0,1000,ttbarG_lep1_pt), np.clip(WZ_lep1_pt,0,1000,WZ_lep1_pt)]

stak_lep2_pt = [np.clip(ZZZ_lep2_pt,0,600,ZZZ_lep2_pt), np.clip(WZZ_lep2_pt,0,600,WZZ_lep2_pt), np.clip(WWW_lep2_pt,0,600,WWW_lep2_pt), np.clip(WWZ_lep2_pt,0,600,WWZ_lep2_pt) , np.clip(WG_lep2_pt,0,600,WG_lep2_pt), np.clip(WW_lep2_pt,0,600,WW_lep2_pt), np.clip(ZG_lep2_pt,0,600,ZG_lep2_pt), np.clip(ZZ_lep2_pt,0,600,ZZ_lep2_pt), np.clip(ttbarG_lep2_pt,0,600,ttbarG_lep2_pt), np.clip(WZ_lep2_pt,0,600,WZ_lep2_pt)]

stak_lep3_pt = [np.clip(ZZZ_lep3_pt,0,800,ZZZ_lep3_pt), np.clip(WZZ_lep3_pt,0,800,WZZ_lep3_pt), np.clip(WWW_lep3_pt,0,800,WWW_lep3_pt), np.clip(WWZ_lep3_pt,0,800,WWZ_lep3_pt) , np.clip(WG_lep3_pt,0,800,WG_lep3_pt), np.clip(WW_lep3_pt,0,800,WW_lep3_pt), np.clip(ZG_lep3_pt,0,800,ZG_lep3_pt), np.clip(ZZ_lep3_pt,0,800,ZZ_lep3_pt), np.clip(ttbarG_lep3_pt,0,800,ttbarG_lep3_pt), np.clip(WZ_lep3_pt,0,800,WZ_lep3_pt)]
...
plt.ylim(0, 350)
plt.text(82, 320, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.xlim(0, 250)
plt.ylim(0, 350)
plt.text(50, 330, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_pho,0,700,WZG_pho), range=(0, 700), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_pho, range=(0, 700), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 700)
plt.ylim(0.01, 10000)
plt.text(250, 2000, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_MET,0,800,WZG_MET), range=(0, 800), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_MET, range=(0, 800), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 800)
plt.ylim(0.01, 10000)
plt.text(250, 2000, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.xlim(0, 1500)
plt.ylim(0.01, 10000)
plt.text(500, 2000, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.xlim(0, 1000)
plt.ylim(0.01, 10000)
plt.text(300, 2000, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.style.use(hep.style.CMS)
bins = np.linspace(0,50,100)
plt.hist(np.clip(WZG_lep2_pt,0,600,WZG_lep2_pt), range=(0, 600), bins=20, weights=scales["WZG"], color='red', histtype='step', label='WZ$\gamma$(signal)', linewidth=3)
plt.hist(stak_lep2_pt, range=(0, 600), alpha=0.7, weights=we, bins=20, color=co, label=la, stacked=True)
plt.title("$\sqrt{s}=14$ TeV, $L=3000$ $fb^{-1}$", fontsize=13, loc='right')
plt.xlim(0, 600)
plt.ylim(0.01, 10000)
plt.text(150, 2000, '($\mu\mu\mu$ channel)', fontsize=20)
...
plt.xlim(0, 800)
plt.ylim(0.01, 10000)
plt.text(200, 2000, '($\mu\mu\mu$ channel)', fontsize=20)
