...
# Data load
Data = '/x4/cms/dylee/Delphes/analysis/ntuple/ntuple/mmm_channel.npy'
#Data = '/x4/cms/dylee/Delphes/analysis/ntuple/oldnpy/mmm_channel.npy'
...
plt.ylim(0, 330)
plt.text(82, 310, '(mmm channel)', fontsize=20)
