...
# Histogram Draw
stak = [ZZZ_Trilep_mass, WZZ_Trilep_mass, WWZ_Trilep_mass, WWW_Trilep_mass, ZZ_Trilep_mass, WZ_Trilep_mass, ttbarG_Trilep_mass, WW_Trilep_mass, ZG_Trilep_mass, WG_Trilep_mass]
...
plt.hist(WZG_Trilep_mass, range=(0, 2000), bins=10, weights=scales["WZG"], color='red', histtype='step', label='WZG(signal)', linewidth=3)
...
plt.text(20, 3000, '(mmm channel)', fontsize=20)
