...
# Data Load
infile = '/x4/cms/dylee/Delphes/analysis/ntuple/numpy/mmm_channel.npy'
...
plt.xlim(0, 500)
#plt.ylim(0, 150)
plt.text(300, 18000, '(mmm channel)', fontsize=20)
...
plt.ylim(0, 150)
plt.text(82, 130, '(mmm channel)', fontsize=20)
...
plt.xlim(0, 200)
plt.ylim(0, 150)
plt.text(10, 135, '(mmm channel)', fontsize=20)
plt.xlabel("$M_{T}$ [GeV]",fontsize=15, loc='center')
plt.ylabel("Expected Number of Events | 10 GeV",fontsize=15, loc='center')
plt.legend(fontsize=12, loc='upper right')
#plt.yscale('log')
...
plt.text(250, 2000, '(mmm channel)', fontsize=20)
...
plt.xlim(0, 3000)
plt.ylim(0.001, 10000)
plt.text(1000, 2000, '(mmm channel)', fontsize=20)
