...
print("signal : {0}".format(eee_df.iloc[1]['weight']))
print("WG {0}".format(eee_df.iloc[110368]['weight']))
#print("ZG {0}".format(eee_df.iloc[]))
...
eee_trilep = eee_df['trilep_mass']
eem_trilep = eem_df['trilep_mass']
emm_trilep = emm_df['trilep_mass']
mmm_trilep = mmm_df['trilep_mass']

# Remove unnecessary columns
eee_df = eee_df.drop(['lep1_F', 'lep2_F', 'lep2_eta', 'trilep_mass'], axis=1)
eem_df = eem_df.drop(['lep1_F', 'lep2_F', 'lep2_eta', 'trilep_mass'], axis=1)
emm_df = emm_df.drop(['lep1_F', 'lep2_F', 'lep2_eta', 'trilep_mass'], axis=1)
mmm_df = mmm_df.drop(['lep1_F', 'lep2_F', 'lep2_eta', 'trilep_mass'], axis=1)
...
eee_df['trilep_mass'] = eee_trilep
eem_df['trilep_mass'] = eem_trilep
emm_df['trilep_mass'] = emm_trilep
mmm_df['trilep_mass'] = mmm_trilep
