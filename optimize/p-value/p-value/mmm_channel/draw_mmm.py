...
p_value = GetPvalue(454.59, 101.63+454.59)
print(p_value)
...
plt.fill_between(array, test, where=array>=sig+bkg, color='red', label='P-Value')
plt.plot(test2, color='black', label='Signal + Background', linewidth=2.0)
plt.text(700, 10e-6, '($\mu\mu\mu$ channel)', fontsize=17)
plt.xlim(200,900)
plt.ylim(10e-25, 10)
plt.legend(fontsize=15, loc='upper right')
plt.yscale('log')
...
mmm_sig = ROOT.Math.gaussian_quantile_c(p_value,1)
